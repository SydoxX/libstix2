...
*/
func Decode(data []byte) (*UserAccount, error) {
	var o UserAccount
...
*/
func (o *UserAccount) UnmarshalJSON(b []byte) error {
...
*/
func (o *UserAccount) Encode() ([]byte, error) {
...
JSON
*/
func (o *UserAccount) EncodeToString() (string, error) {
	data, err := o.Encode()
	if err != nil {
		return "", err
	}
